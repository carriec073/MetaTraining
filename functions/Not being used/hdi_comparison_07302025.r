...
overlap <- min(hdi_meta_bio_T2[2], hdi_bio_none[2]) - max(hdi_meta_bio_T2[1], hdi_bio_none[1])
...
if(overlap_exists) {
  ...
  union_length <- max(hdi_meta_bio_T2[2], hdi_bio_none[2]) - min(hdi_meta_bio_T2[1], hdi_bio_none[1])
